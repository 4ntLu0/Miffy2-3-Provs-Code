...
#define MOT_LDRIVE_1 3
#define MOT_LDRIVE_2 7
#define MOT_RDRIVE_1 2
#define MOT_RDRIVE_2 8
#define MOT_FLY 4
#define MOT_INTAKE 6
#define MOT_INDEX 5

#define OSE_FLYWHEEL_TOP 2
#define OSE_FLYWHEEL_BOTTOM 1
#define OSE_DRIVE_LEFT_TOP 8
#define OSE_DRIVE_LEFT_BOTTOM 9
#define OSE_DRIVE_RIGHT_TOP 6
#define OSE_DRIVE_RIGHT_BOTTOM 7
#define OSE_DRIVE_PERP_TOP 11
#define OSE_DRIVE_PERP_BOTTOM 12
...
#define JUMPER_AUTO 10

Encoder flyOSE;
Encoder driveLeftOSE;
Encoder driveRightOSE;
Encoder drivePerpOSE;
